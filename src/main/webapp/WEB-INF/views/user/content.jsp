			...
			<div class="row services">
				...
				<div class="col-md-4">
					<div id="rockSissorPaper" class="service">
						<div class="icon-holder">
							<img src="${img}/icons/rock.png" alt="" class="icon">
						</div>
				...
				<div class="col-md-4">
					<div id="major_subject_1" class="service">
						<div class="icon-holder">
							<img src="${img}/icons/java.png" alt="" class="icon">
						</div>
				...
				<div class="col-md-4">
					<div id="major_subject_2" class="service">
						<div class="icon-holder">
							<img src="${img}/icons/javascript.png" alt="" class="icon">
						</div>
				...
				<div class="col-md-4">
					<div id="major_subject_3" class="service">
						<div class="icon-holder">
							<img src="${img}/icons/sql.png" alt="" class="icon">
						</div>
